...
description: Use when a complete, single-file reference copy of every installed Superpowers skill and supporting file is needed.
---

# Superpowers Complete Reference

This file contains a verbatim, sectioned copy of every text file installed from the Superpowers repository. It is a reference archive; use the original individual skills for normal automatic skill selection.

## Source: `brainstorming/scripts/frame-template.html`
...
````
## Source: `brainstorming/scripts/helper.js`
...
````
## Source: `brainstorming/scripts/server.cjs`
...
````
## Source: `brainstorming/scripts/start-server.sh`
...
````
## Source: `brainstorming/scripts/stop-server.sh`
...
````
## Source: `brainstorming/spec-document-reviewer-prompt.md`
...
````
## Source: `brainstorming/visual-companion.md`
...
````
## Source: `requesting-code-review/code-reviewer.md`
...
````
## Source: `subagent-driven-development/re-review-prompt.md`
...
````
## Source: `subagent-driven-development/scripts/review-package`
...
````
## Source: `subagent-driven-development/scripts/sdd-workspace`
...
````
## Source: `subagent-driven-development/scripts/task-brief`
...
````
## Source: `subagent-driven-development/task-reviewer-prompt.md`
...
````
## Source: `systematic-debugging/condition-based-waiting-example.ts`
...
````
## Source: `systematic-debugging/condition-based-waiting.md`
...
````
## Source: `systematic-debugging/CREATION-LOG.md`
...
````
## Source: `systematic-debugging/defense-in-depth.md`
...
````
## Source: `systematic-debugging/find-polluter.sh`
...
````
## Source: `systematic-debugging/root-cause-tracing.md`
...
````
## Source: `systematic-debugging/test-academic.md`
...
````
## Source: `systematic-debugging/test-pressure-1.md`
...
````
## Source: `systematic-debugging/test-pressure-2.md`
...
````
## Source: `systematic-debugging/test-pressure-3.md`
...
````
## Source: `test-driven-development/writing-good-tests.md`
...
````
## Source: `using-superpowers/references/antigravity-tools.md`
...
````
## Source: `using-superpowers/references/codex-tools.md`
...
````
## Source: `using-superpowers/references/gemini-tools.md`
...
````
## Source: `using-superpowers/references/hermes-tools.md`
...
````
## Source: `using-superpowers/references/pi-tools.md`
...
````
## Source: `using-superpowers/SKILL.md`
...
````
## Source: `writing-plans/plan-document-reviewer-prompt.md`
...
````
## Source: `writing-skills/examples/CLAUDE_MD_TESTING.md`
...
````
## Source: `writing-skills/graphviz-conventions.dot`
...
````
## Source: `writing-skills/persuasion-principles.md`
...
````
## Source: `writing-skills/render-graphs.js`
...
````
## Source: `writing-skills/testing-skills-with-subagents.md`
...
````
<!-- END SECTION: writing-skills_testing-skills-with-subagents_md -->
